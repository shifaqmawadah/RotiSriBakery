...
if (isset($_POST["update"])) {
  ...
  $stmt = $dbh->conn()->prepare("UPDATE Items SET Name=?, Brand=?, Description=?, Category=?, SellingPrice=?, QuantityInStock=?, Image=? WHERE ItemID=?");
  $stmt->bind_param("sssisisi", $name, $brand, $description, $category, $sellingprice, $quantityinstock, $image, $itemID);
